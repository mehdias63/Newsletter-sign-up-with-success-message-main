...
function App() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 justify-center items-center font-robo text-dark-gray p-6 rounded-2xl">
      {!success ? (
        <>
        <div className="md:w-[48rem] lg:w-[58rem] bg-white rounded-2xl flex flex-col md:flex-row gap-3 justify-center items-center md:grid md:grid-cols-2 p-4">
      ...
      <div className="md:col-start-1 md:row-start-1 lg:ml-6">
